        ...
        $this->widget('bootstrap.widgets.TbNavbar', array(
            ...
            'items' => array(
                ...
                array(
                    ...
                    'items' => array(
                        array('label' => 'Login', 'url' => array('/user/login'), 'icon' => 'fa fa-unlock', 'visible' => Yii::app()->user->isGuest),
                        //'---',
                        array('label' => '', 'url' => '#', 'icon' => 'fa fa-user', 'visible' => !Yii::app()->user->isGuest, 'items' => array(
                                array('label' => 'Logout (' . Yii::app()->user->name . ')', 'url' => Yii::app()->getBaseUrl() . '/index.php/user/logout', 'icon' => 'fa fa-power-off',),
                                array('label' => 'My Profile', 'url' => Yii::app()->getBaseUrl() . '/index.php/user/profile', 'icon' => 'fa fa-user',),
                            )),
                    ),
                ),
            ),

<div class="row">
    <div class="col-sm-3 col-lg-2" style="position: relative;margin-top: 30px;"> 
        <ul class="nav nav-pills nav-stacked nav-email" style="position: fixed;border: 2px solid #44AFB0;border-top-left-radius: 9px;border-top-right-radius: 9px;">
            ...
            <li title="View Inactive Customer"><a href="<?php echo Yii::app()->createUrl("/user/admin/inactive"); ?>">   <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/theme_images/question_report.png"/> Inactive Customer</a></li>
            <li title="View Banned Customer"  class="active"><a href="<?php echo Yii::app()->createUrl("/user/admin/banned"); ?>">   <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/theme_images/question_testi.png"/> Banned Customer</a></li>
        </ul>
    ...
    <div class="col-md-10">
        <div class="block-web">
            <div class="header">
                <h3 class="content-header">All Banned Customer</h3>
            </div>

    ...
    <div class="col-md-4">
        <div class="block-web">
            <div class="user-profile-sidebar">
                <div class="row">
                    <div class="col-md-4"> <img alt="Avatar" class="img-circle" src="<?php
                        echo Yii::app()->request->baseUrl . '/' . $profile->getAttribute('organisation_logo');
                        ?>"> </div>
                    <div class="col-md-8">
            ...
            <?php /* ?>
              ...
              <div class="col-md-4">
              <h5><strong><?php echo TabletMaster::getAllTablet_Count_User($_GET['id']); ?></strong> Question</h5>
              </div>
              <div class="col-md-4">
              <h5><strong><?php echo QuestionMaster::getAllQuestion_Count_User($_GET['id']); ?></strong> Tablets</h5>
              </div>
              </div>
              </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <address>
                                    ...
                                    <a href="mailto:<?php echo User::model()->findByPk($_GET['id'])->email; ?>"><?php echo User::model()->findByPk($_GET['id'])->email; ?></a>
                                </address>
                            </div>
                        </div>
                    ...
                    <div class="user-profile-content">
                        <div class="porlets-content">
                            ...
                            $form = $this->beginWidget('CActiveForm', array(
                                'id' => 'profile-form',
                                'action' => Yii::app()->request->baseUrl . '/index.php/user/admin/update/id/' . $model->id,
...
//                                                echo $profile->organisation_logo;
                                                ?>
                                                <img src = "<?php echo Yii::app()->request->baseUrl . '/' . User::model()->findByPK($model->id)->profile->organisation_logo; ?>"> 
                                    ...
                                    <table id="user" class="table table-bordered table-striped" style="clear: both">
                                        ...
                                        <tbody>
                                            ...
                                            $Branches = BranchMaster::model()->findAll(array(
                                                ...
                                                'params' => array(':customer_id' => $model->id)
                                            ));

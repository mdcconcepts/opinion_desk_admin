<?php
/* @var $this MessageMasterController */
/* @var $model MessageMaster */

$this->breadcrumbs=array(
	'Message Masters'=>array('index'),
	'Manage',
);
...
$this->menu=array(
	array('label'=>'MessageMaster','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' => $menu)	
);
...
$('.search-form form').submit(function(){
	$('#message-master-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});

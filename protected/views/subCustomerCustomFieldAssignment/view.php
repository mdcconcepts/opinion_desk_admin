...
$this->menu=array(
	array('label'=>'View SubCustomerCustomFieldAssignment','url'=>array('view','id'=>$model->id),'icon'=>'fa fa-eye','active'=>true),
	// Add child model
...
<?php $box = $this->beginWidget(
    ...
    array(
        'title' => 'View Sub Customer Custom Field Assignments #'.$model->id,

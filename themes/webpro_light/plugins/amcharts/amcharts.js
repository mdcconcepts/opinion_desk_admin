...
AmCharts.wrappedText = function (a, b, c, d, e, f, g, h, k) {
    ...
    if (l) {
        ...
        if (n.width > h) {
            ...
            for (var q, p = 0; p < l.length; p += Math.ceil(l.length / n))
                q = l[p], b = b.substr(0, q) + m + b.substr(q + 1);
            if (isNaN(q)) {
                if (0 == k)
                    for (p = 1; p < n; p++)
                        q = Math.round(b.length / n * p), b = b.substr(0, q) + m + b.substr(q);
...
AmCharts.ValueAxis = AmCharts.Class({inherits: AmCharts.AxisBase, construct: function (a) {
        ...
        if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
            ...
            this.exponential = !1;
            for (f = p; f < q; f += n)
                s = AmCharts.roundTo(this.step * f + this.min, t), -1 != String(s).indexOf("e") && (this.exponential = !0, String(s).split("e"));
                ...
                if (p = t * f + this.min, d && this.max - this.min > 5 * this.min && (p -= this.min), p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)
                    if (isNaN(w) || Number(AmCharts.toFixed(p, w)) == p) {
                        ...
                        if (!isNaN(I) && 0 < s && f < q - 1) {
                            ...
                            for (e = 1; e < t / I; e++)
                                u = this.getCoordinate(p + I * e), u = new this.axisItemRenderer(this, u, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(u);
                            this.gridAlpha = v
                        }
                    }
            r = this.baseValue;
...
AmCharts.RecItem = AmCharts.Class({construct: function (a, b, c, d, e, f, g, h, k, l, m) {
        ...
        m = a.labelRotation;
        var V = a.counter, T = a.inside, fa = a.labelOffset, aa = a.dx, ga = a.dy, Na = a.orientation, ma = a.position, ba = a.previousCoord, O = a.viH, X = a.viW, na = a.offset, $, W;
...
AmCharts.AmChart = AmCharts.Class({construct: function (a) {
        ...
        this.pf = {precision: this.percentPrecision, thousandsSeparator: this.thousandsSeparator,
...
AmCharts.AmGraph = AmCharts.Class({construct: function (a) {
        ...
        isNaN(h) && (h = .8);
        var l = this.useNegativeColorIfDown, m = this.width, n = this.height, p = this.y, q = this.rotate, r = this.columnCount, t = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), w = this.connect, v = [], s = [], u, x, F, B, z = this.chart.graphs.length, I, E = this.dx / this.tcc, H = this.dy / this.tcc, V = f.stackType,
                T = this.start, fa = this.end, aa = this.scrollbar, ga = this.categoryAxis, Na = this.baseCoord, ma = this.negativeBase, ba = this.columnIndex, O = this.lineThickness, X = this.lineAlpha, na = this.lineColorR, $ = this.dashLength, W = this.set, Y, ja = this.getGradRotation(), G = this.chart.columnSpacing, A = ga.cellWidth, ka = (A * h - r) / r;
        G > ka && (G = ka);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)
            if (this.stackable && "regular" == V || "100%" == V || this.fillToGraph)
                Ea = !0;
        ...
        for (J = T; J <= fa; J++) {
            ...
            if (l && void 0 == this.openField)
                for (var kb = J + 1; kb < d.length && (!d[kb] ||
                    ...
                    ;
            var R, N, L, ca, ha = NaN, D = NaN, C = NaN, M = NaN, K = NaN, Ha = NaN, xa = NaN, Ia = NaN, ya = NaN, sa = NaN, ta = NaN, da = NaN, ea = NaN, U = NaN, lb = NaN, mb = NaN, ia = NaN, qa = void 0, Ca = jb, Ka = Oa, ua = na, oa, ra, nb = this.proCandlesticks, Sa = this.pattern;
            ...
            if (va) {
                ...
                if ("candlestick" == g || "ohlc" == g)
                    U = va.close, mb = va.low, xa = f.getCoordinate(mb), lb = va.high, ya = f.getCoordinate(lb);
                ia = va.open;
                C = f.getCoordinate(U);
                ...
                var ha =
                        S.x[ga.id], La = this.periodSpan - 1, la = Math.floor(A / 2) + Math.floor(La * A / 2), za = la, cb = 0;
                ...
                if (!nb && U < ia || nb && U < Y)
                    y.isNegative = !0, Da && (Ca = Da), Pa && (Ka = Pa), void 0 != wa && (ua = wa);
                Qa = !1;
                isNaN(U) || (l ? U > Ga ? (Fa && (Qa = !0), Fa = !1) : (Fa || (Qa = !0), Fa = !0) : y.isNegative = U < ma ? !0 : !1, Y = U);
                switch (g) {
                    case "line":
                        if (isNaN(U))
                            w || (this.drawLineGraph(v, s, P, Q), v = [], s = [], P = [], Q = []);
                        else {
                            if (Math.abs(D - $a) >= bb || Math.abs(C - ab) >= bb)
                                v.push(D), s.push(C), $a = D, ab = C;
                            sa = D;
                            ta = C;
                            da = D;
                            ea = C;
                            !Ea || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K));
                            if (Qa || void 0 != y.lineColor || void 0 != y.fillColors || !isNaN(y.dashLength))
                                this.drawLineGraph(v, s, P, Q), v = [D], s = [C], P = [], Q = [], !Ea || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K)), l ? Fa ? (this.lineColorSwitched = na, this.fillColorsSwitched = jb) : (this.lineColorSwitched = wa, this.fillColorsSwitched = Da) : (this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors), this.dashLengthSwitched = y.dashLength;
                            y.gap && (this.drawLineGraph(v, s, P, Q), v = [], s = [], P = [], Q = [])
                        }
                        break;
                    case "smoothedLine":
                        if (isNaN(U))
                            w || (this.drawSmoothedGraph(v,
                                    s, P, Q), v = [], s = [], P = [], Q = []);
                        else {
                            if (Math.abs(D - $a) >= bb || Math.abs(C - ab) >= bb)
                                v.push(D), s.push(C), $a = D, ab = C;
                    ...
                    case "step":
                        if (!isNaN(U)) {
                            ...
                            if (Eb || y.gap)
                                u = x = NaN, this.drawLineGraph(v, s, P, Q), v = [], s = [], P = [], Q = []
                        } else if (!w) {
                            if (1 >= this.periodSpan || 1 < this.periodSpan && D - u > la + za)
                                u = x = NaN;
                    ...
                    case "column":
                        ...
                        if (!isNaN(U)) {
                            ...
                            if (qa && (ra = qa.set, y.columnGraphics = ra, ra.translate(R, N), this.columnsSet.push(ra), (y.url || this.showHandOnHover) && ra.setAttr("cursor", "pointer"), !aa)) {
                                ...
                                if ("regular" == V || "100%" == V)
                                    I = q ? 0 < va.value ? (this.end + 1 - J) * z + c : (this.end + 1 - J) * z - c : 0 < va.value ? z * J + c : z * J - c;
                        ...
                        if (!(isNaN(ia) || isNaN(lb) || isNaN(mb) || isNaN(U))) {
                            ...
                            if (q) {
                                ...
                                var zb = D - h / 2, zb = AmCharts.fitToBounds(zb,
                                        0, m), Jb = AmCharts.fitToBounds(D, 0, m), Ab = D + h / 2, Ab = AmCharts.fitToBounds(Ab, 0, m);
        ...
        if ("line" ==
            ...
            "smoothedLine" == g ? this.drawSmoothedGraph(v, s, P, Q) : this.drawLineGraph(v, s, P, Q), aa || this.launchAnimation();
        ...
        if (1 < a.length) {
            ...
            if (0 < f || 0 < s)
                if (n = a.join(";").split(";"), q = b.join(";").split(";"), m = g.type, "serial" == m ? 0 < c.length ? (c.reverse(), d.reverse(), n = a.concat(c), q = b.concat(d)) : e.rotate ? (q.push(q[q.length - 1]), n.push(u),
                        ...
                        q, r, f, 1, "#000", 0, a), g.pattern(e.pattern), k.push(g)), v || void 0 !== t)
                    isNaN(s) && (s = f), v || (v = t), h = AmCharts.polygon(h, n, q, v, s, 1, "#000", 0, a), h.pattern(e.pattern), l.push(h), l.click(function (a) {
                        e.handleGraphEvent(a, "clickGraph")
                    }).mouseover(function (a) {
                        e.handleGraphEvent(a, "rollOverGraph")
                    }).mouseout(function (a) {
        ...
        if (!isNaN(b) && !isNaN(c)) {
            ...
            if (this.customBullet || a.customBullet)
                p = this.customBullet, a.customBullet && (p = a.customBullet), p && (n && n.remove(), "function" == typeof p ? (n = new p,
...
AmCharts.ChartCursor = AmCharts.Class({construct: function (a) {
                ...
                if (c.mouseIsOver || F || B || this.forceShow)
                    if (this.forceShow = !1, B) {
                        ...
                        if (!g.parseDates || g.equalSpacing)
                            e = Math.round(e);
                        0 !== e && (h = {type: "zoomed", target: this}, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + e > u && (e = u - c), F + e < s && (e = s - F), h.start = Math.round(F + e), h.end = Math.round(c + e), this.fire(h.type, h)) : I + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = I + e, this.fire(h.type, h)))
                    } else {
                        ...
                        if (this.oneBalloonOnly) {
                            ...
                            for (g = 0; g < z.length; g++)
                                s = z[g], s.showBalloon && !s.hidden && s.balloonText && (u = q.axes[s.valueAxis.id].graphs[s.id], v = u.y, isNaN(v) || (t ? Math.abs(e - v) < r && (r = Math.abs(e - v), I = s) : Math.abs(f - v) < r && (r = Math.abs(f - v), I = s)));
                            ...
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], z && this.valueBalloonsEnabled && w && c.balloon.enabled) {
                                ...
                                for (g = 0; g < z.length; g++)
                                    if (s = z[g], v = NaN, (!this.oneBalloonOnly || s == I) && s.showBalloon && !s.hidden && s.balloonText && ("step" == s.type && "left" == s.stepDirection && (q = this.data[a + 1]), q)) {
                                        if (u = q.axes[s.valueAxis.id].graphs[s.id])
                                            v = u.y;
                                        if (this.showNextAvailable && isNaN(v) && a + 1 < this.data.length)
                                            for (r = a + 1; r < this.data.length; r++)
                                                if (d = this.data[r])
                                                    if (u = d.axes[s.valueAxis.id].graphs[s.id], v = u.y, !isNaN(v))
                                                        break;
                                        if (!isNaN(v)) {
                                            d = u.x;
                                            k = !0;
                                            ...
                                            k && (k = this.graphBulletSize,
                                                    ...
                                                    void 0 !== s.balloonTextColor && (k.color = s.balloonTextColor), k.setPosition(r + l, d + m), r = c.formatString(s.balloonText, u, !0), (d = s.balloonFunction) && (r = d(u, s).toString()), "" !== r && (t ? k.showBalloon(r) : (k.text = r, k.show = !0), w.push({yy: v, balloon: k})), !t && k.set && (k.set.hide(), s = k.textDiv) && (s.style.visibility = "hidden"))
                                        }
                                    }
        ...
        if (this.zoomable || this.pan || this.drawing) {
            ...
            if (0 < d && d < this.width && 0 < e && e < this.height || "fake" == a)
                this.setPosition(), this.selectWithoutZooming && AmCharts.remove(this.selection), this.drawing ? (this.drawStartY =
...
AmCharts.AmBalloon = AmCharts.Class({construct: function (a) {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                B < g && (B = g);
                B + z > k && (B = k - z);
                var h = x + t, l = B + r, t = this.shadowAlpha, E = this.shadowColor, r = this.borderThickness, H = this.bulletSize, V;
...
AmCharts.AmSlicedChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function (a) {
        ...
        1 == b ? (a.pulled = !0, this.pullOutOnlyOne && this.pullInAll(a.index), a = {type: "pullOutSlice",
            dataItem: a, chart: this}) : (a.pulled = !1, a = {type: "pullInSlice", dataItem: a, chart: this});
        this.fire(a.type, a)
        ...
        if (void 0 !== b) {
            ...
            1 < b && (this.groupValue = 0, this.removeSmallSlices(), a.push({title: this.groupedTitle, value: this.groupValue, percents: this.groupValue / d * 100, pulled: this.groupedPulled, color: this.groupedColor, url: this.groupedUrl, description: this.groupedDescription, alpha: this.groupedAlpha,
                pattern: this.groupedPattern, dataContext: {}}));
            c = this.baseColor;
...
AmCharts.TrendLine = AmCharts.Class({construct: function (a) {
        ...
        var a = this;
        a.destroy();
        var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, n = a.finalCategory, p = a.valueAxis, q = a.valueAxisX, r = a.initialXValue, t = a.finalXValue, w = a.initialValue, v = a.finalValue,
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    359.94 < t && (t = 359.94);
    e >= t && (e = t);
    var w = 1 / 180 * Math.PI, t = b + Math.sin(d * w) * h, v = c - Math.cos(d * w) * q, s = b + Math.sin(d * w) * f, u = c - Math.cos(d * w) * g, x = b + Math.sin((d + e) * w) * f, F = c - Math.cos((d + e) * w) * g, B = b + Math.sin((d + e) * w) * h, w = c - Math.cos((d + e) * w) * q, z = {fill: AmCharts.adjustLuminosity(l.fill, -.2), "stroke-opacity": 0, "fill-opacity": l["fill-opacity"]}, I = 0;
    180 < Math.abs(e) && (I = 1);
    d = a.set();
    var E;
...
AmCharts.AmLegend = AmCharts.Class({construct: function (a) {
        ...
        if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
            "center" == this.align ? b = f + (h - s.width) / 2 : "right" == this.align && (b = f + h - s.width);
        w.translate(b, l + 1);
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings)
                if (m =
                        a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m)
                    ...
                    !0 === a.hidden &&
                            (m = d);
                    if (g = this.createMarker("rectangle", m, a.fillAlphas, a.lineThickness, d, a.lineAlpha, q, g))
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            c = b.container.rect(a.legendEntryWidth, 0, e, f, 0, 0).attr({stroke: "none", fill: "#fff", "fill-opacity": .005});
            c.dItem = a;
